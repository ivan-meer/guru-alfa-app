...
export function LocationsPage() {
  ...
  // Get all locations from all directions
  const locations = directions.flatMap(dir => 
  ...
  const handleEdit = (location: Location) => {
    setFormData({
      ...
      horizontal_cover: location.horizontal_cover || '',
      category: location.category || '',
      directionId: location.directionId
    });
          ...
          >
            <div className="flex">
              <div className="relative w-48 h-48">
                <img
                  src={location.thumbnail || DEFAULT_IMAGES.LOCATION}
                  alt={location.title}
                ...
                <div className="flex justify-between">
                  <div>
                    ...
                    <div className="flex items-center text-sm text-gray-500 dark:text-gray-400 mb-4">
                      ...
                      <span>{location.directionName}</span>
                      <span className="mx-2">•</span>
                      <span>{location.points?.length || 0} точек</span>
                    </div>
                  </div>
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Например: Пляж Карон"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700"
                    placeholder="Подробное описание локации..."
                  />
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium mb-1">Миниатюра</label>
                    <input
                      type="text"
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.horizontal_cover}
                      onChange={(e) => setFormData({ ...formData, horizontal_cover: e.target.value })}
                      className="w-full px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700"
                      placeholder="URL изображения"
                    />
                  </div>
